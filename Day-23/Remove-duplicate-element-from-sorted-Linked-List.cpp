...
Approach -> use two pointers one is assigned to head and other is head->next and now compare the data of both pointers in linked list if equal the delete it.*/
